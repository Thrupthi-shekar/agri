	...
	<head>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Culture Fam<span>Ravikiran</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9019225781</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:ravikiransh017@gmail.com" style="color:white">ravikiransh017@gmail.com</a></p>
			</div>
		</div>
    ...
    <h3>Login</h3>
							<form method="post" action="Login/login.php">
								<div class="row uniform 50%">
									<div class="7u$">
										<input type="text" name="name" id="name" value="" placeholder="UserName" style="width:80%" required/>
									</div>
									<div class="7u$">
									...
									<div class="row uniform">
										...
										<form>
											<label for="options"> <h3> choose an option:</h3> <br></label> 
											<select id="type" name="category">
												<option value="1" class=optn>Farmer</option>
												<option value="0" class=optn>Buyer</option>
											</select>
										</form>
									</div>
									<center>
...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
									...
									<form>
											<label for="options"> <h3>choose an option:</h3></label>
											<select id="type" name="category">
